...
#ScraperWikiMorph.save_metadata('authority_name', 'Blue Mountains City Council')
#ScraperWikiMorph.save_metadata('authority_short', 'Blue Mountains')
#ScraperWikiMorph.save_metadata('state', 'NSW')
